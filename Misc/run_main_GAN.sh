...
#$ -N Main_GAN                  # Specify the job name
...
#$ -o GAN_err.log   # Specify the output file for stdout
#$ -e GAN_out.log    # Specify the output file for stderr
...
papermill /projectnb/ec523kb/projects/teams_Fall_2024/Team_11/Adwait/discriminator_with_pooling.ipynb
