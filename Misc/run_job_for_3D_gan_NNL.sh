...
#$ -N Run_Jupyter_NNL        # Specify the job name
...
#$ -o job_output_NNL.log     # Specify the output file for stdout
#$ -e job_error_NNL.log      # Specify the output file for stderr
...
papermill /projectnb/ec523kb/projects/teams_Fall_2024/Team_11/Adwait/Work_on_this_code/Phew/CGAN_NNL.ipynb
