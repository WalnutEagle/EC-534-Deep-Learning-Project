...
#$ -N Run_Jupyter_XCT        # Specify the job name
#$ -l mem_per_core=3G        # Request memory per core (adjust as needed)
...
#$ -o job_output_XCT_P.log   # Specify the output file for stdout
#$ -e job_error_XCT_P.log    # Specify the output file for stderr
...
papermill /projectnb/ec523kb/projects/teams_Fall_2024/Team_11/Adwait/Work_on_this_code/Phew/onelasttry.ipynb